...
Int16 filter_taps[SAMPLEFILTER_TAP_NUM] = {
  -1318,
  -3829,
  -4009,
  -717,
...
/*
short Convolve(SampleFilter *f, short data3)
{
	int k;
	        	  for(k = 0; k < SAMPLEFILTER_TAP_NUM; ++k)
	        	    f->history[k] = 0;

	        	  f->last_index = 0;
	        	  f->history[f->last_index++] = data3;
...
// FILTER HER
        	...
        	void SampleFilter_put(SampleFilter *f, Int16 input){
